...
<!-- Vector Map js -->
<script src="{{ asset('template/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js') }}?v={{ time() }}"></script>
<script src="{{ asset('template/assets/vendor/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js') }}?v={{ time() }}"></script>
